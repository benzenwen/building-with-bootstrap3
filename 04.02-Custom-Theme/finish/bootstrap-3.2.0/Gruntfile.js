...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      dist: {
        options: { force: true }, // Needed to delete above cwd
        src: ['dist', 'docs/dist', '../custom-dist']
      }
    },
...
//           'js/affix.js'
  ...
  // BPE distribution task.
  grunt.registerTask('dist-bpe', 'copy:bpe');

  // Full distribution task.
  grunt.registerTask('dist', ['clean', 'dist-css', 'copy:fonts', 'dist-js', 'dist-docs', 'dist-bpe']);
